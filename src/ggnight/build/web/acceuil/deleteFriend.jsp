								...
								<tbody>
									<%for(int i=0 ; i<Friends.size() ; i++){ %>
										<tr>
											...
											<td><input id="delete" type="submit" class="btn btn-primary" value="Supprimer" /></td>
											<td><input type="hidden" id="idUser" value="<%=ID_USER%>" /></td>
											<td><input type="hidden" id="idFriend" value="<%=Friends.get(i).getId() %>" /></td>
										<tr>
									<%} %>
								</tbody>
							</table>
