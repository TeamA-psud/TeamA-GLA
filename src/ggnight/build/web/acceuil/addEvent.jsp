...
<head>
	...
	<title>Organiser une soirée</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-8">
				<h4 class="page-header">Organiser une soirée</h4>
			</div>
		</div><!--/.row-->
		...
		<form action="http://localhost:8080/ggnight/EventControl" method="GET">
			...
			<%if(Friends.toString() != "[]"){ %>
				...
				<div class="form-group">
					<label>Heure du début de la soirée</label>
					<input type="time" name="time" id="debutHeure" class="form-control"/>
				</div>
                                <div class="form-group">
					<label>Heure fin soirée</label>
			...
			<%}else{ %>
				<h5>Aucun ami existé pour organiser une soirée</h5>
			<%} %>
		</form>
	</div>	<!--/.main-->
