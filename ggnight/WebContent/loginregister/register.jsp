		...
		<div class="container-login100">
			...
			<span class="login100-form-title p-b-33">
				...
				<form>
    				...
    				<input type="number" class="form-control" id="age" placeholder="Entrer votre age" required="required">
  					</div>
  					<div class="form-group">
    				<label for="nom">Adresse</label>
    				<input type="text" class="form-control" id="adresse" placeholder="Entrer votre adresse" required="required">
  					</div>
  					<div class="form-group">
    				<label for="nom">Date de naissance</label>
    				<input type="date" class="form-control" id="datenaiss" placeholder="Entrer votre date de naissance" required="required">
  					</div>
  					<div class="form-group">
    				<label for="nom">Email</label>
    				<input type="email" class="form-control" id="email" placeholder="Entrer votre Email" required="required">
  					</div>
  					<div class="form-group">
    				<label for="nom">Password</label>
    				<input type="password" class="form-control" id="password" placeholder="Entrer votre password" required="required">
  					</div>
  					<div class="form-group">
    				<label for="nom">Budget</label>
    				<input type="number" class="form-control" id="budget" placeholder="Entrer votre budget" required="required">
  					</div>
  					<div class="form-group">
    				<label for="nom">Numéro de téléphone</label>
    				<input type="number" class="form-control" id="phone" placeholder="Entrer votre numéro de téléphone" required="required">
  					</div>
  					<div class="form-group">
